...
class mechanicController extends Controller
{
  ...
  protected $mechanic;
/**
 * COntructor que prepara el repository y los middlewares
 * @param MechanicRepository $mechanic [description]
 */
   ...
   * @param  Request $request contenido que deja el usuario
  ...
  public function index(Request $request)
  {
    ...
    {
      $mechanics = Cache::remember('mechanics',20/60, function(){
        return $this->mechanic->All();
      });
    }else{
        $mechanics =$this->mechanic->AllKA();
    }
  ...
  /**
   * Mostrar el contenido de la bd segun el identificador
   * @param  int $mechanic identificdor de mecanica
...
/**
 * Metodo que se encargade guardar el contenido en la base de datos
 * @param  Request $request contenido enviado por el cliente
 * @return json           Devuelve un json con el ultimo recursos insertado
 */
